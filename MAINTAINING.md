...
We have a [template repo](https://github.com/micronaut-projects/micronaut-crac-tests) that we use as the single
...
[Release GitHub Action workflow](https://github.com/micronaut-projects/micronaut-crac-tests/blob/master/.github/workflows/release.yml)
