...
Sign the [Contributor License Agreement (CLA)](https://cla-assistant.io/micronaut-projects/micronaut-crac-tests). This is required before any of your code or pull-requests are accepted.
...
Micronaut crac-tests currently requires JDK 8.

## IDE Setup

Micronaut crac-tests can be imported into IntelliJ IDEA by opening the `build.gradle` file.

## Docker Setup

Micronaut crac-tests tests currently require Docker to be installed.
